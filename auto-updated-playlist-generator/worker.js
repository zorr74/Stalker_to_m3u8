// Stalker-Portal Playlist live Generator Script
// Created by: @tg_aadi 
...
const config = {
    ...
    mac_address: '00:1A:79:00:5C:6D', // Replace with your MAC address
    serial_number: '436613AC7210D', // Replace with your serial number
    device_id: 'F33CE35DD81647CA8BA6FF4A7941D7B8B7392F39976FCA6B20CB2E22F3C041B1', // Replace with your device_id
    device_id_2: 'F33CE35DD81647CA8BA6FF4A7941D7B8B7392F39976FCA6B20CB2E22F3C041B1', // Replace with your device_id_2
    stb_type: 'MAG250', // Replace with Stalker-Portal Stb_type
    api_signature: '263', // No need to change 
    stream_url: 'https://sky-stream.tgaadi.workers.dev/${real_cmd}.m3u8' // Replace with your Stream Url 
};
// =========================================
// Auto-generate hw_version_2
// Note: Replace md5 with a proper implementation (e.g., from a library like md5.js)
config.hw_version = '1.7-BD-' + md5(config.mac_address).substring(0, 2).toUpperCase();
config.hw_version_2 = md5(config.serial_number.toLowerCase() + config.mac_address);


function md5(str) {
    console.warn('MD5 function is a placeholder. Replace with a proper MD5 implementation.');
    return str; 
}
...
async function convertJsonToM3U(channels, profile, account_info, request) {
    ...
    if (!channels.length) {
        ...
        channels.forEach((channel, index) => {
            ...
            // Replace ${real_cmd} in stream_url with the actual real_cmd value
            const channel_stream_url = config.stream_url.replace('${real_cmd}', real_cmd);
...
async function handleRequest(request) {
    // Check if the request is for /playlist.m3u8
